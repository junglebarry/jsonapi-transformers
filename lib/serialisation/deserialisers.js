...
exports.fromJsonApiResourceObject = exports.fromJsonApiTopLevel = exports.byTypeAndId = void 0;
...
function fromJsonApiTopLevel(topLevel, resourceObjects) {
    ...
    if (Array.isArray(data)) {
        deserialised = data.map(function (datum) {
            return fromJsonApiResourceObject(datum, resourceObjectsByTypeAndId, deserialisedObjectsByTypeAndId);
        });
    }
    else if (data) {
    ...
    Object.keys(relationshipMetadata).forEach(function (relationshipName) {
        ...
        if (data && Array.isArray(data)) {
            instance[relationshipName] = data
                .map(function (datum) {
                return extractResourceObject(datum, allowUnresolvedIdentifiers);
            })
...
function extractResourceObjectFromRelationship(relationIdentifier, resourceObjectsByTypeAndId, deserialisedObjects, allowUnresolvedIdentifiers) {
    ...
    var deserialisedObject = relationId
...
function extractResourceObjectOrObjectsFromRelationship(resourceLinkage, resourceObjectsByTypeAndId, deserialisedObjects, allowUnresolvedIdentifiers) {
    var extractResourceObject = function (linkage) {
        return extractResourceObjectFromRelationship(linkage, resourceObjectsByTypeAndId, deserialisedObjects, allowUnresolvedIdentifiers);
    };
