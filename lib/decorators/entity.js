...
exports.entity = exports.getConstructorForJsonapiType = exports.getClassForJsonapiType = exports.ENTITIES_MAP = exports.TypeMap = void 0;
    ...
    return function (original) {
        ...
        var construct = function (constructorFunc, args) {
            var CustomJsonapiEntity = function () {
                return new (constructorFunc.bind.apply(constructorFunc, __spreadArrays([void 0], args)))();
            };
